...
//   return (
//     <header className={`sticky top-0 z-50 w-full max-w-[1480px] backdrop-blur-lg  transition-colors duration-300 ${
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              ...
              className={`hidden sm:inline-block px-4 py-2 font-medium rounded-md transition-all shadow-sm hover:shadow-md ${
                isScrolled ? "bg-black hover:shadow-lg hover:shadow-[#0066cc] text-white" : "bg-black hover:shadow-lg hover:shadow-blue-100 text-white"
              }`}
            >
              Create Free Account ✨
            </Link>
