...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (firstSection) {
        ...
        setIsScrolled(window.scrollY > sectionHeight)
      }
    }
  ...
  return (
    <header className={`sticky top-0 z-50 w-full max-w-[1480px] backdrop-blur-lg shadow-sm border-b border-gray-100 transition-colors duration-300 ${
      ...
      <div className="mx-auto relative">
        <div className="flex justify-between h-16 items-center px-3 sm:px-4 md:px-5 lg:px-10">
          ...
          <div className="flex items-center justify-center space-x-4 sm:space-x-8">
            <div className="flex items-start flex-col space-y-0 leading-none">
              <Link href="/" className="flex items-center group">
                ...
                <small className={`text-[10px] m-0 p-0 leading-none ${
                  isScrolled ? 'text-gray-400' : 'text-blue-100'
                }`}>
            ...
            <nav className="hidden lg:flex space-x-2">
              <li ref={triggerRef} className="list-none relative">
                <button
                  onClick={toggleProductPage}
                  className={`flex items-center space-x-1 px-4 py-2 rounded-lg transition-all ${
                    productPage ? "bg-blue-50 text-blue-600" : 
                    isScrolled ? "text-gray-600 hover:bg-gray-100" : "text-blue-100 hover:bg-blue-700"
                  }`}
                >
                  <span>Products</span>
                  <svg
          ...
          <div className="hidden sm:flex items-center space-x-3">
            ...
            <Link
              href="/signup"
              className={`px-4 py-2 font-medium rounded-md transition-all shadow-sm hover:shadow-md ${
                isScrolled 
          ...
          <div className="sm:hidden flex items-center">
            <Link
              href="/signin"
              className={`px-3 py-1.5 mr-2 rounded-md font-medium text-sm ${
            ...
            >
              <svg 
                className={`h-6 w-6 ${isScrolled ? "text-gray-600" : "text-blue-100"}`}
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
